  ...
  const handleAddToCart = () => {
    ...
    try {
      ...
      if (quantity > pQuantity) {
        toast.error("Not enough product available.", { duration: 3000 });
        return;
      }
              ...
              <div className="md:w-1/2  flex flex-col md:mx-8 lg:mx-14 xl:mx-15">
                ...
                <table className="max-w-xs text-left">
                  <tbody>
                    ...
                    <tr className="">
                      <td className="font-semibold text-gray-700">Category:</td>
                      <td className="capitalize font-semibold text-gray-500 dark:text-white">
                        {product.category}
                      </td>
                    </tr>
                    ...
                    <tr className="">
                      <td className="font-semibold text-gray-700">Shipping:</td>
                      <td className="capitalize font-semibold text-gray-500 dark:text-white">
                        Full Free
                      </td>
                    </tr>
