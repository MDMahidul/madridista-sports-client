  ...
  return (
    <div>
      <FadeInUpAnimation>
          ...
          <Container>
            <div className="flex flex-col md:flex-row justify-between  gap-10 md:gap-0">
              <aside className="md:w-1/4">
                ...
                <p className="mt-2 text-base text-justify font-medium text-gray-700">
              ...
              <nav className="md:w-1/4">
                ...
                <div className="flex flex-col space-y-3 text-base dark:text-white font-medium text-gray-700">
              ...
              <nav>
                ...
                <div className="flex flex-col gap-4 md:gap-0 items-start md:space-y-3 text-base  text-gray-700 font-medium">
        ...
        <div className="text-center p-6 bg-amber-100 text-base-content border-t border-slate-300 font-medium">
